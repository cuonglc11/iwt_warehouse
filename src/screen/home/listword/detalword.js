...
import { View, SafeAreaView, Text, ScrollView, TouchableOpacity, Image, Alert } from 'react-native'
import CustomTop from "../../../componet/CustomTop";
import { app_color } from "../../../contant/color";
const DetalWordScreen = ({ navigation }) => {
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <CustomTop text={"Công việc"}
            ...
            <ScrollView style={{ backgroundColor: "#F5F5F5" }}>
                ...
                <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', margin: 10 }}>Thông tin</Text>
                <View style={{ margin: 10, flexDirection: 'row' }}>
                    <Text style={{ fontSize: 14, color: "#8C8D8E" }}>Tuyến cáp : Sơn Trà 01 </Text>
                    <TouchableOpacity
                        onPress={() => navigation.replace('detalInfohome')}

                    >
                        <Text style={{ fontSize: 12, color: app_color, fontWeight: 'bold' }}>Chi tiết thông tin </Text>
                    </TouchableOpacity>
                </View>
                <Text style={{ fontSize: 14, margin: 10, color: "#8C8D8E", fontWeight: 'bold' }}>Thời gian yêu cầu: 10:30 - 08/08/2022</Text>
                <Text style={{ fontSize: 14, margin: 10, color: "#8C8D8E" }}>Yêu cầu xử lý : 120 phút</Text>
                <View style={{ borderBottomColor: "rgba(0, 0, 0, 0.13)", margin: 10, padding: 10, borderBottomWidth: 4, backgroundColor: "#fff" }}>
                    <Text style={{ color: 'black', fontSize: 14, fontWeight: 'bold' }}>Thông tin sự cố </Text>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, marginBottom: 20 }}>
                    <TouchableOpacity 
                    onPress={() => {
                        Alert.alert("Thông Báo", "Bạn muốn từ chối công việc không ",
                        [
                            {
                                text: "Đồng ý",
                                onPress: () => {
                    ...
                    <TouchableOpacity style={{ flex: 1, backgroundColor: "#fff", marginStart: 10, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        <Image source={require('../../../asset/img/ChatText.png')} style={{ tintColor: app_color, height: 20, width: 20 }} />
                        <View style={{ flexDirection: 'column' }}>
                            <Text style={{ color: app_color, fontSize: 12, fontWeight: 'bold', marginStart: 10 }}>Yêu cầu </Text>
                            <Text style={{ color: app_color, fontSize: 12, fontWeight: 'bold', marginStart: 10 }}>hỗ trợ </Text>
                    ...
                    <TouchableOpacity
                        ...
                        style={{ flex: 2, backgroundColor: "#fff", marginStart: 10, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                        <Image source={require('../../../asset/img/writing.png')} style={{ tintColor: app_color, height: 20, width: 20 }} />
                        <Text style={{ color: app_color, fontSize: 12, fontWeight: 'bold', marginStart: 10 }}>Báo cáo hoàn thành</Text>
...
export default DetalWordScreen