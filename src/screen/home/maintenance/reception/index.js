...
const ReceptionMaintenance = ({ navigation }) => {
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <CustomTop text={"Tiếp nhận yêu cầu bảo trì"}
                onclick={() => {
                    navigation.replace('createmaintenance')
                }}
            />
            <ScrollView style={{ backgroundColor: "#F5F5F5" }}>
                <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', margin: 10 }}>Thông tin yêu cầu bảo trì</Text>
                ...
                <View style={{ margin: 10, flexDirection: 'row' }}>
                    ...
                    >
                        <Text style={{ fontSize: 12, color: app_color, fontWeight: 'bold', marginTop: 2 }}>Chi tiết thông tin </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ flexDirection: 'row', marginTop: 10, marginBottom: 20 }}>
                    ...
                    <TouchableOpacity
                       onPress={() => {
                        navigation.replace('mainsucccess')
                    }}
                    style={{ flex: 1, backgroundColor: "#fff", padding: 10, flexDirection: 'row' , marginStart : 10, alignItems: 'center', justifyContent: 'center' }}>
                        <Image source={require('../../../../asset/img/writing.png')} style={{ tintColor: app_color, height: 20, width: 20 }} />
