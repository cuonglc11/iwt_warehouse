...
const EditRouteMainScreen = ({ navigation }) => {
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <CustomTop text={"Chi tiết thông tin"} 
            onclick={() =>{
                navigation.replace('detalmain')
            }}
            />
            <ScrollView style={{ flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', margin: 10 }}>
                    ...
                    style={{ flex: 1 }}>
                        <Text style={{ color: app_color, fontWeight: 'bold', marginTop : 5, fontSize: 14 }}>
                            Danh sách tuyến
                        </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={{ flexDirection: 'row', margin: 10 }}>
                    <Text style={{ fontSize: 18 }}>
                        ...
                        <Text style={{ color: 'black' , marginStart : 10 , fontWeight: 'bold', fontSize: 18 }}>
                           HĐ xxxxxxxxxxxxx
                ...
                <View style={{ flexDirection: 'row', margin: 10 }}>
                    <Text style={{ fontSize: 18 }}>
                        ...
                        <Text style={{ color: 'black' , marginStart : 10 , marginTop : 5 , fontWeight: 'bold', fontSize: 15 }}>
                          23/04/2022  - 23/04/2025
...
export default EditRouteMainScreen