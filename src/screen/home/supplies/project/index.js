                ...
                <View style={{ flex: 3, backgroundColor: '#fff', borderTopStartRadius: 40, borderTopEndRadius: 40, padding: 10 }}>
                    <ScrollView style={{ padding: 5 }}>
                        <View style={{ flexDirection: 'row' }}>
                            <TouchableOpacity
                             onPress={()=> {
                                navigation.replace('listproject')
                             }}
                            style={{ alignItems: 'center', justifyContent: 'center' , flex : 1 }}>
                                <Image source={require('../../../../asset/img/listbook.png')} style={{ height: 30, width: 30, marginTop: 12, tintColor: app_color }} />
                            ...
                            <TouchableOpacity
                             onPress={() => {
                                navigation.replace('listprojectsupplies')
                             }}
                            style={{ alignItems: 'center', justifyContent: 'center' ,flex : 1 }}>
                            ...
                            <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center' , flex : 1 }}>
                                ...
                                <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center', marginTop : 12  }}>
                                    <Text style={{ color: app_color, fontSize: 12 }}>Tạo kho </Text>
                                    <Text style={{ color: app_color, fontSize: 12 }}>dự án mới</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
